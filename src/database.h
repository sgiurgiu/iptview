...
public:
    ...
    void SetupSchema();
    int64_t AddRetrieveXStreamServer(const XStreamAuthenticationInfo &xstreamServerInfo) const;
    QString GetXStreamServerTimezone(int64_t id) const;
    std::vector<XStreamAuthenticationInfo> GetAllXStreamServers() const;

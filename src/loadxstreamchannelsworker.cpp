...
LoadXstreamChannelsWorker::LoadXstreamChannelsWorker(XStreamCollectedInfo list, QObject *parent)
...
void LoadXstreamChannelsWorker::loadGroup(const XStreamCategoryInfo &category,
